...
const Home = () => (
    ...
    <div className="ContentTitle" >Cash Disbursement Office 
     ...
     /// image //*
       ...
       <div class="row">
           ...
           <h3 class="user-name m-t-0 m-b-0">Prof. Paul John Capote</h3>
     ...
     <div class="row">
         ...
         <h1 className="officetitle">Cash Disbursement Office</h1>
         <h3 className="officeitem">The  Cash Disbursement Office  is a small, boxy room, presumably used as an office for whoever Zero is 
...
const ModalAppointment = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const Prefix = ("PUPPQ")
    const Office = ("Cash Disbursement Office")
