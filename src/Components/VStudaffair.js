...
const Home = () => (
    ...
    <div className="ContentTitle" >Student Affairs and Services office
     ...
     /// image //*
       ...
       <div class="row">
           ...
           <h3 class="user-name m-t-0 m-b-0">Prof. Mila Joy Martinez</h3>
     ...
     <Card className="Cardinfo" height={"200px"}>
       ...
       <div class="row">
           ...
           <h1 className="officetitle">Student Affairs and Services Office</h1>
           <h3 className="officeitem">The Student Affairs and Services office is a small, boxy room, presumably used as an office for whoever Zero is 
...
const ModalAppointment = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const Prefix = ("PUPPQ")
    const Office = ("Student Affairs and Services Office")
