...
const Home = () => (
    ...
    <div className="ContentTitle" >Academic Head office
     ...
     /// image //*
       ...
       <div class="row">
           ...
           <h3 class="user-name m-t-0 m-b-0">Prof. Catherine Llave</h3>
           <small class="text-muted">Academic Head</small>
     ...
     <Card className="Cardinfo" height={"200px"}>
       ...
       <div class="row">
           ...
           <h1 className="officetitle">Academic Head Office</h1>
           <h3 className="officeitem">The Academic Head office is a small, boxy room, presumably used as an office for whoever Zero is 
...
const ModalAppointment = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const Prefix = ("PUPPQ")
    const Office = ("Academic Head Office")
