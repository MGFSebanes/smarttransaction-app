import { Button, Space, Card, Row, Col, Divider, Avatar, Table, Image,  DatePicker, Input, Modal, Checkbox, Select, 
    TimePicker, Form, message, Typography  } from "antd";
  ...
  const Home = () => (
      ...
      <div className="ContentTitle" >Director's Office
       ...
       /// image //*
         ...
         <div class="row">
             ...
             <h3 class="user-name m-t-0 m-b-0">Dr. Cleotilde Crescini</h3>
       ...
       <Card className="Cardinfo" height={"200px"}>
         ...
         <div class="row">
             ...
             <h1 className="officetitle">Director's Office</h1>
             <h3 className="officeitem">The Director's office is a small, boxy room, presumably used as an office for whoever Zero is 
  ...
  ///////
    ...
    const ModalAppointment = () => {
      ...
      const handleSubmit = (event) => {
        ...
        const Prefix = ("PUPPQ")
        const Office = ("Director's Office")
