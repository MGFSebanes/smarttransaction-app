import './Profile.css';
import {BellOutlined, MessageOutlined, CaretDownOutlined, MenuOutlined, UserOutlined,MailOutlined,UnorderedListOutlined,FileTextOutlined,UploadOutlined,
  MenuUnfoldOutlined, MenuFoldOutlined} from "@ant-design/icons";
  ...
  return (
    <Layout>
      ...
      >
        ...
        <Button
            type="text"
            icon={collapsed ? <MenuUnfoldOutlined style={{top:'20px'}}/> : 
            <>
    ...
    function BodyContent(){
      return(
        <div>
           ...
           <Routes>
              <Route path="/" element={<FacultyProfile />}></Route>
