...
const Home = () => (
    ...
    <div className="ContentTitle" >Quality Assurance Office
     ...
     /// image //*
       ...
       <div class="row">
           ...
           <h3 class="user-name m-t-0 m-b-0">Prof. Archie Arevalo</h3>
     ...
     <Card className="Cardinfo" height={"200px"}>
       ...
       <div class="row">
           ...
           <h1 className="officetitle">Quality Assurance Office</h1>
           <h3 className="officeitem">The  Quality Assurance Office is a small, boxy room, presumably used as an office for whoever Zero is 
...
const ModalAppointment = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const Prefix = ("PUPPQ")
    const Office = ("Quality Assurance Office")
