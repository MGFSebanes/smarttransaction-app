...
const Home = () => (
    ...
    <div className="ContentTitle" >Records and Admission office
     ...
     /// image //*
       ...
       <div class="row">
           ...
           <h3 class="user-name m-t-0 m-b-0">Prof. Ribert Enierga</h3>
           <small class="text-muted">Records and Admission</small>
     ...
     <Card className="Cardinfo" height={"200px"}>
       ...
       <div class="row">
           ...
           <h1 className="officetitle">Records and Admission Office</h1>
           <h3 className="officeitem">The Records and Admission office is a small, boxy room, presumably used as an office for whoever Zero is 
  ...
  const ModalAppointment = () => {
    ...
    const handleSubmit = (event) => {
      ...
      const Prefix = ("PUPPQ")
      const Office = ("Records and Admission Office")
      ...
      data.map(datas => {
        ...
        const studNo = (event.studentNo)
        const ProgramYrSec = (event.yearsection)
                ...
                <Form form={form} onFinish={handleSubmit} >
                  <Form.Item label="Student No">
                    <Form.Item
                        ...
                        >
                      <Input placeholder="Enter Student No" style={{width:'150px', marginBottom: '0px',}}/>
                    </Form.Item>
                  </Form.Item>
                  </Form>
                  ...
                  <Form form={form} onFinish={handleSubmit} >
                  <Form.Item label="Program Year-Section" style={{marginTop:'-45px'}}>
                    <Form.Item
                          name="yearsection"
                          rules={[
                            {
                        ...
                        >
                      <Input placeholder="Enter Year-Section" style={{width:'150px', marginBottom: '0px',}}/>
                    </Form.Item>
                  </Form.Item>
                  </Form>
                  <div className="rep3" style={{marginTop:'-50px'}}>Email: {datas.Gmail}</div>
