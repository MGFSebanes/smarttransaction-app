...
import {BellOutlined, MessageOutlined, CaretDownOutlined, MenuOutlined, UserOutlined,MailOutlined,UnorderedListOutlined,FileTextOutlined,
  UploadOutlined, MenuUnfoldOutlined, MenuFoldOutlined, HomeOutlined, FundProjectionScreenOutlined, SolutionOutlined, UserSwitchOutlined} from "@ant-design/icons";
...
const App = () => {
  ...
  return (
    <Layout>
      ...
      style={{overflow: 'auto', height: '100vh', position: 'sticky', left: 0, top: 0, bottom: 0, background:"#2c3E50"}} width={"345px"}>
        ...
        <Button type="text" icon={collapsed ? <MenuUnfoldOutlined style={{top:'20px'}}/> : 
            <>
          <MenuFoldOutlined style={{marginLeft:"20px", marginRight:"40px"}}/>
    ...
    const items = [
      ...
      const PUPLogo = () => (
         <>
            ...
            <img alt="" src={puplogo} width="60" height="60"  className="logo" style={{marginTop:'2px'}}
        />
                ...
                items ={[
                  {
                    label: "Dashboard" ,
                    key: "Dashboard",
                    icon: <HomeOutlined  style={{fontSize: '80%'}}/>
                  ...
                  },
                  {
                    label: "Transactions",
                    key: "Transactions",
                    icon: <SolutionOutlined  style={{fontSize: '80%'}}/>
                  },
                  {
                    label: "User logs",
                    key: "Userlogs",
                    icon: <UserSwitchOutlined style={{fontSize: '80%'}}/>
                  },
                  {
                    label: "Blog Post",
                    key: "Blogpost",
